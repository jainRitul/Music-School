    ...
    return(
     ...
     />
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Dive into our comprehnsive music courses and transform your musical journey today. Weather you are a beginner or looking to refine your skills,join us to unlock your true potential.</p>
            <div className="mt-4">
                <Link href={"/courses"}>
